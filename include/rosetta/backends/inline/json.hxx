...
// visitor in <rosetta/visitors/json.h> (rosetta::to_json /
...
`rosetta::from_json` in `<rosetta/visitors/json.h>` handle every
...
```)MD";
        ...
        inline std::string json_demo(const GenContext &c) {
            ...
            d += "#include <rosetta/visitors/json.h>\n";
        ...
        inline void Json::emit(const GenContext &c) const {
