...
// after nanobind_backend.h and python_backend.h (whose qualify_std()
...
mode is a wheel-only switch (`-DROSETTA_STABLE_ABI=ON` to force it by hand).)MD";
        ...
        // (py_lit / qualify_std come from python_backend.hxx.)
        ...
        inline void NanobindBackend::emit(const GenContext &c) const {
            ...
            // python_backend.hxx); only pyproject.toml and the ABI
