...
\title{\vspace{-2cm}\Huge\textbf{\rosetta}\\[0.4cm]
       \LARGE A User's Guide\\[0.6cm]
       \large Multi-language bindings for unmodified C++,\\
       generated once with C++26 static reflection}
\author{Frantz Maerten\\\small\texttt{fmaerten@gmail.com}}
\date{\today}
...
\input{ch/02-pipeline}
\input{ch/03-first-binding}
...
\input{ch/11-rosetta-gen}
\input{ch/12-coverage}

\part{Beyond bindings}
\input{ch/13-dynamic}
\input{ch/14-scriptable}
\input{ch/15-extending}

\part{Worked examples}
\input{ch/16-examples}

\appendix
\part{Reference}
\input{ch/app-a-manifest}
\input{ch/app-b-annotations}
\input{ch/app-c-targets}
